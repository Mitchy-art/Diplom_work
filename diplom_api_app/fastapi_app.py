...
async def startup():
    ...
    if not pets_:
        pets_list = [
            {"name": "Костик", "age": "2 года", "species": "кот", "breed": "Сибирская голубая гладкошерстная"},
            {"name": "Милка", "age": "3 года", "species": "пес", "breed": "Дворовая"},
            {"name": "Макси", "age": "5 лет", "species": "пес", "breed": "Дворовая"},
            {"name": "Тедди", "age": "2 месяца", "species": "кот", "breed": "Тайская"},
            {"name": "Клео", "age": "5 лет", "species": "кот", "breed": "Дворовая"},
        ]
...
@app.get("/shop_page", response_class=HTMLResponse)
...
async def register_post(request: Request,
    ...
    query = users.insert().values(username=username, password_hash=hashed_password, age=age, email=email)
